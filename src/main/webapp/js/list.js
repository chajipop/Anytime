...
/*		 	* 현재 페이지가 1페이지의 경우 *
		...
		<li class="page-item"><a href="BoardList.bo?page=2" class="page-link">2</a></li>								
		<li class="page-item"><a href="BoardList.bo?page=2" class="page-link">&nbsp;다음</a></li>	
*/
function ajax(sdata){
	console.log(sdata)
