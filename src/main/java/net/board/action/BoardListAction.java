...
public class BoardListAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
	    ...
	    */
		 ...
		 *  시작페이지는 21(startpage=21)와 마지막페이지는 30(endapge=30) 이지만
		...
		if(state == null) {
			...
			//void com.google.gson.JsonObject.add(String property, JsonElement value) 메소드를 통해서 저장합니다.
