...
public class BoardDAO {
	...
	public int boardReply(BoardBean board) {
	     ...
	     *  글 목록에서 보여줄때 하나의 그룹으로 묶어서 출력됩니다.
	     */
	     ...
	     *  원문인 경우에는 이 값이 0이고 원문의 답그은 1, 답그의 답글은 2가 됩니다.
	     */
	...
	public void reply_update(Connection con, int re_ref, int re_seq) throws Exception{
		//BOARD_RE_REF, BOAR_RE_SEQ 값을 확인하여 원문 글에 답글이 달려있다면
	...
	private int reply_insert(Connection con, BoardBean board, int re_ref, int re_lev, int re_seq) throws Exception{
		int num=0;
